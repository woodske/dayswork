...
- **Current Stage**: U-15 Recurring Lifecycle + Calendar Handlers — **Functional Design + NFR Requirements APPROVED 2026-05-21. NFR Design IN PROGRESS** (artifacts at [u-15-recurring-lifecycle/nfr-design/](construction/u-15-recurring-lifecycle/nfr-design/); no blocking questions per precedent; introduces Patterns Q–U). FD/NFR-Req artifacts under [u-15-recurring-lifecycle/](construction/u-15-recurring-lifecycle/). Decisions: FD-Q1=A, Q2=A, Q3→Clar-1a=C, Q4=B, Q5=A, Q6=C, Q7=A, Q8=C(+Clar-2), Q9=C(+Clar-3). NEXT (on approval) -> U-15 Infrastructure Design (SKIP) -> Code Generation.
